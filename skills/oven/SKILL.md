...
| `@tknf/oven/auth`       | `Guard`, `Policy`, `hashPassword`/`verifyPassword`, `ApiToken`, `RememberToken`, `EmailVerification`, `PasswordReset`, `OAuthClient`, `generateTotpSecret`/`buildOtpauthUrl`/`generateTotpCode`/`verifyTotpCode` (RFC 6238 TOTP)                                                                                                                                                                       |
